...
/**
 * Heart Pharma brand mark
 * A realistic-looking vector heart with teal pharmaceutical styling.
 * Fully transparent background — blends naturally with any surface.
 */
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Heart shape - smooth, pharmacy-friendly */}
        <path
          d="M50 85 C 26 66, 5 50, 5 29 C 5 15.5, 16.2 6.5, 29.8 6.5 C 39.2 6.5, 47.1 11.1, 50 18.3 C 52.9 11.1, 60.8 6.5, 70.2 6.5 C 83.8 6.5, 95 15.5, 95 29 C 95 50, 74 66, 50 85 Z"
          fill="url(#hp-heart-body)"
        />
        {/* Top glossy highlight */}
        <path
          d="M50 18.3 C 47.1 11.1, 39.2 6.5, 29.8 6.5 C 19.5 6.5, 10.8 12.8, 7.8 21.8 C 14.2 16.2, 21.5 14.9, 29 18.9 C 37.8 23.6, 43.5 29.8, 48.2 38.5 C 49.5 30.4, 50.6 23.9, 50 18.3 Z"
          fill="url(#hp-heart-shine)"
        />
        {/* Left rim light */}
        <path
          d="M50 85 C 26 66, 5 50, 5 29 C 5 25.2, 5.8 21.7, 7.2 18.6 C 7 27.8, 11.2 37.5, 19.5 46.8 C 30.8 59.5, 41.6 71.2, 50 79.5 L 50 85 Z"
          fill="url(#hp-heart-rim)"
        />
        {/* Subtle inner glow */}
        <path
          d="M50 85 C 26 66, 5 50, 5 29 C 5 15.5, 16.2 6.5, 29.8 6.5 C 39.2 6.5, 47.1 11.1, 50 18.3 C 52.9 11.1, 60.8 6.5, 70.2 6.5 C 83.8 6.5, 95 15.5, 95 29 C 95 50, 74 66, 50 85 Z"
          fill="url(#hp-heart-glow)"
